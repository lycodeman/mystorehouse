...
import kotlinx.android.synthetic.main.fragment_screen_info_8.*
 ...
 */
class ScreenInfo8Fragment : BaseEmptyFragment(), CancelAdapt {
    ...
    override fun initContentId(): Int {
        return R.layout.fragment_screen_info_8
    }
