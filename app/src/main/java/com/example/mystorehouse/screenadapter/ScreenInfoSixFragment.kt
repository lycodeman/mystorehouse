...
import kotlinx.android.synthetic.main.fragment_screen_info_six.*
 ...
 */
class ScreenInfoSixFragment : BaseEmptyFragment() , CancelAdapt {
    ...
    override fun initContentId(): Int {
        return R.layout.fragment_screen_info_six
    }
