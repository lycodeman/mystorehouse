...
import kotlinx.android.synthetic.main.fragment_screen_info_10.*
 ...
 */
class ScreenInfo10Fragment : BaseEmptyFragment(),CancelAdapt {
    ...
    override fun initContentId(): Int {
        return R.layout.fragment_screen_info_10
    }
